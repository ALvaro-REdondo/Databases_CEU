...
public class SQLitePatientManager implements PatientManager {
	...
	public List<Patient> searchPatientByName(String name) {
		...
		try {
			...
			while (rs.next()) {
				...
				Patient newPatient = new Patient(id, PatientName, PatientGender, PatientState, PatientDOB,
						PatientPathology_id, PatientClinicalHistory_id);// pathology_id
	...
	public Patient searchPatientById(int PatientId) {
		...
		try {
			...
			int PatientPathology_id = rs.getInt("pathology_id");
			int PatientClinicalHistory_id = rs.getInt("clinical_history_id");
			patient = new Patient(id, PatientName, PatientGender, PatientState, PatientDOB, PatientPathology_id,
					PatientClinicalHistory_id);// pathology_id
