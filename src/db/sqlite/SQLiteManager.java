	...
	public void createTables() {
		...
		try {
			...
			String sql2 = "CREATE TABLE Treatment " + "(id       INTEGER  PRIMARY KEY AUTOINCREMENT,"
					+ " name     TEXT     NOT NULL, " + " medication  TEXT	 NOT NULL, " + " description TEXT )";
			stmt1.executeUpdate(sql2);
			stmt1 = c.createStatement();
			String sql3 = "CREATE TABLE Pathology " + "(id       INTEGER  PRIMARY KEY AUTOINCREMENT,"
					+ " name     TEXT     NOT NULL, " + " startDate DATE NOT NULL, " + " endingDate DATE, "
					+ " treatmentId INTEGER REFERENCES Treatment(id))";
			stmt1.executeUpdate(sql3);
			stmt1 = c.createStatement();
			String sql4 = "CREATE TABLE Allergy " + "(id       INTEGER  PRIMARY KEY AUTOINCREMENT,"
					+ " allergy     TEXT     NOT NULL, " + " degree  INTEGER	 NOT NULL )";
			stmt1.executeUpdate(sql4);
			stmt1 = c.createStatement();
			String sql5 = "CREATE TABLE ClinicalHistory " + "(id       INTEGER  PRIMARY KEY AUTOINCREMENT,"
					+ " doe     DATE     NOT NULL, " + " dod  DATE, " + " bloodType TEXT NOT NULL, "
					+ " extraInfo TEXT, " + " allergyId INTEGER REFERENCES Allergy(id))";
			stmt1.executeUpdate(sql5);
			stmt1 = c.createStatement();
			String sql6 = "CREATE TABLE Patient " + "(id       INTEGER  PRIMARY KEY AUTOINCREMENT,"
					+ " name     TEXT     NOT NULL, " + " gender  TEXT	 NOT NULL, " + " state TEXT NOT NULL, "
					+ " dob INTEGER NOT NULL, " + " pathology_id INTEGER REFERENCES Pathology(id),"
					+ " clinical_history_id INTEGER REFERENCES ClinicalHistory(id))";
			stmt1.executeUpdate(sql6);
			stmt1 = c.createStatement();
			String sql7 = "CREATE TABLE MedicalPersonnel " + "(id       INTEGER  PRIMARY KEY AUTOINCREMENT,"
