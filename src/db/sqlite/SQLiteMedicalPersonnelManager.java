...
public class SQLiteMedicalPersonnelManager implements MedicalPersonnelManager {
	...
	public List<MedicalPersonnel> showMedicalPersonnel() {
		...
		try {
			...
			while (rs.next()) {
				...
				MedicalPersonnel newMedicalPersonnel = new MedicalPersonnel(id, name, department, position,
						pathologyId);
	...
	public List<MedicalPersonnel> searchMedicalPersonnelByName(String name) {
		...
		try {
			...
			// Search medical personnel that has the same name as the one inserted by the
			// user.
	...
	public List<MedicalPersonnel> searchMedicalPersonnelByPathologyId(Integer pathologyId) {
		...
		try {
			...
			// Search medical personnel that has the same id as the one inserted by the
			// user.
			...
			while (rs2.next()) {
				...
				MedicalPersonnel medicalPersonnel = new MedicalPersonnel(id, name, department, position,
						medicalPersonnelPathologyId);
